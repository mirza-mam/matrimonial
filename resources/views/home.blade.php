@extends('layout.main')
@push('header')
    <title>Home | Select Proposal</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
@endpush
@section('section')
    <div class="row mx-4 m-2 custom-border">
        <div class="col-md-2 start-head-img">
        </div>
        <div class="col-md-5 p-5 custom-border-right">
            <h2 class="heading-red">why Pakistan's matrimonial platform?</h2>
            <p>Unlike traditional rishta theory and matchmaking,
                we rely on a cooperative, interactive bond between
                our representatives and our clients.</p>
        </div>
        <div class="col-md-5 p-5">
            <h2 class="heading-red ">How to use and pricing ?</h2>
            <p>Unlike traditional rishta theory and matchmaking,
                we rely on a cooperative, interactive bond between
                our representatives and our clients.</p>
        </div>
    </div>
    <div class="row p-3 m-0" style="background-color: black">
        <div class="col-md-2 heading-white text-end">ANNOUNCEMENT:</div>
        <div class="col-md-10 text-white">
            <marquee>We only approve educated person’s profiles (Minimum education Bachelors).</marquee>
        </div>
    </div>
    ...
    <div class="row mx-3 mt-4 mb-4">
        ...
        <div class="col-md-8 m-0 p-4 px-5 overflow-auto"
            style="background-image: url({{ asset('front/images/2.png') }});background-repeat: no-repeat;background-position: center;background-size: 100% 100%;padding: 5.5% !important;">
        ...
        <div class="col-md-2 p-3 rounded overflow-auto" style="background-color: #8f8b8f">
            <div class="mb-4">
                ...
                <div style="background-color: #f9f9f9;">
                    <div class="dropdown">
                        <button class="dropbtn"><span>Saudi Arabia</span> <i class="fa-solid fa-angle-right"
                                style="float: right"></i></button>
                        <div class="dropdown-content" style="float: right">
                            <a href="{{ url('islamabad/male/single') }}">Male</a>                            
                            <a href="{{ url('islamabad/female/single') }}">Female</a>                            
                        </div>
                    </div>
                    <div class="dropdown">
                        <button class="dropbtn"><span>UAE</span> <i class="fa-solid fa-angle-right"
                                style="float: right"></i></button>
                        <div class="dropdown-content" style="float: right">
                            <a href="{{ url('karachi/male/single') }}">Male</a>                            
                            <a href="{{ url('karachi/female/single') }}">Female</a>                            
                        </div>
                    </div>
                    <div class="dropdown">
                        <button class="dropbtn"><span>Bahrain</span> <i class="fa-solid fa-angle-right"
                                style="float: right"></i></button>
                        <div class="dropdown-content" style="float: right">
                            <a href="{{ url('lahore/male/single') }}">Male</a>                            
                            <a href="{{ url('lahore/female/single') }}">Female</a>                            
                        </div>
                    </div>
                    <div class="dropdown">
                        <button class="dropbtn"><span>Qatar</span> <i class="fa-solid fa-angle-right"
                                style="float: right"></i></button>
                        <div class="dropdown-content" style="float: right">
                            <a href="{{ url('lahore/male/single') }}">Male</a>
                            <a href="{{ url('lahore/female/single') }}">Female</a>                            
                    ...
                    <div class="dropdown">
                        <button class="dropbtn"><span>Kuwait</span> <i class="fa-solid fa-angle-right"
                                style="float: right"></i></button>
                        <div class="dropdown-content" style="float: right">
                            <a href="{{ url('lahore/male/single') }}">Male</a>                            
                            <a href="{{ url('lahore/female/single') }}">Female</a>
                    ...
                    <div class="dropdown">
                        <button class="dropbtn"><span>UK</span> <i class="fa-solid fa-angle-right"
                                style="float: right"></i></button>
                        <div class="dropdown-content" style="float: right">
                            <a href="{{ url('lahore/male/single') }}">Male Single</a>
                            <a href="{{ url('lahore/male/divorced') }}">Male Divorced</a>
                    ...
                    <div class="dropdown">
                        <button class="dropbtn"><span>USA</span> <i class="fa-solid fa-angle-right"
                                style="float: right"></i></button>
                        <div class="dropdown-content" style="float: right">
                            <a href="{{ url('lahore/male/single') }}">Male</a>
                            <a href="{{ url('lahore/female/single') }}">Female</a>                            
                    ...
                    <div class="dropdown">
                        <button class="dropbtn"><span>Canada</span> <i class="fa-solid fa-angle-right"
                                style="float: right"></i></button>
                        <div class="dropdown-content" style="float: right">
                            <a href="{{ url('lahore/male/single') }}">Male</a>
                            <a href="{{ url('lahore/female/single') }}">Female</a>                            
                    ...
                    <div class="dropdown">
                        <button class="dropbtn"><span>Australia</span> <i class="fa-solid fa-angle-right"
                                style="float: right"></i></button>
                        <div class="dropdown-content" style="float: right">
                            <a href="{{ url('lahore/male/single') }}">Male</a>                            
                            <a href="{{ url('lahore/female/single') }}">Female</a>                        
            ...
            <form method="POST" action="{{ route('user.search') }}">
                ...
                <div class="mb-4">
                    <h5 class="heading-white">Country</h5>
                    <div>
