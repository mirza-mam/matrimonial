            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2 text-capitalize">SP Admin</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item @if ($active=='user') active @endif">
                    ...
                    <li class="menu-item @if ($active=='country') active @endif">
                    ...
                    <li class="menu-item @if ($active=='state') active @endif">
                    ...
                    <li class="menu-item @if ($active=='city') active @endif">
                    ...
                    <li class="menu-item @if ($active=='setting') active @endif">
                        <a href="{{ route('admin.web-setting') }}" class="menu-link">
                                        ...
                                        <a class="dropdown-item" href="javascript:void(0)">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small
                                                        class="text-muted">{{ session()->get('admin.username') }}</small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
